...
def main():
    # 读取原图
    image_raw = cv2.imread('img/slideBlock.png')
    ...
    cv2.imwrite('crabCV/image_gaussian_blur.png', image_gaussian_blur)
    # Canny边缘检测
    image_canny = get_canny_image(image_gaussian_blur)
    cv2.imwrite('crabCV/image_canny.png', image_canny)
    # 轮廓提取
    ...
    cv2.imwrite("img/tp.png", crop)  # 保存在本地
